...
export function MakerApp({ onExit }: MakerAppProps) {
  ...
  if (!snapshot) {
    return (
      <Box padding={1}>
        <Text>Inicializando estratégia de market making…</Text>
      </Box>
    );
  }
  ...
  return (
    <Box flexDirection="column" paddingX={1}>
      <Box flexDirection="column" marginBottom={1}>
        ...
        <Text color="gray">Status: {snapshot.ready ? "Executando em tempo real" : "Aguardando dados de mercado"} ｜ Pressione Esc para voltar à seleção de estratégia</Text>
      </Box>
