!!! info "[ApiWithdrawalHistoryRequest](/../../schemas/api_withdrawal_history_request)"
    ...
    |-|-|-|-|
    |currency<br>`c` |[string]|True|The token currency to query for, if nil or empty, return all withdrawals. Otherwise, only entries matching the filter will be returned|
